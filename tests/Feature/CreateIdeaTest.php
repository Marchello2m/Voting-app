...
class CreateIdeaTest extends TestCase
{
    ...
    public function create_idea_from_does_not_show_when_logged_out()
    {
    ...
    public function create_idea_from_does_show_when_logged_in()
    {
    ...
    /** @test */
    public function creating_two_ideas_whit_same_title_still_works_but_has_different_slags()
    {
        $user = User::factory()->create();
        $categoryOne = Category::factory()->create(['name' => 'Category 1']);
        $categoryTwo = Category::factory()->create(['name' => 'Category 2']);
