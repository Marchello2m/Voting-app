                        ...
                        <div x-data="{ isOpen: false }"class="relative" >
                            <button @click="isOpen = !isOpen">
                                ...
                                <div class="absolute rounded-full bg-red text-white text-xxs w-6 h-6 flex justify-center
                                 items-center border-2 -top-1 -right-1">8</div>
                            </button>
                            <ul
                                class="absolute w-76 md:w-96 text-left text-gray-700 text-sm bg-white shadow-dialog
                                rounded-xl max-h-128 overflow-y-auto z-10 -right-28 md:-right-12"
                                {{-- style="right: -46px" --}}
                                x-cloak
                            ...
                            >
                                <li>
                                    ...
                                    >
                                        <img src="https://s.gravatar.com/avatar/5f6728474d8b5356723019d370ed6a0d?s=80"
                                ...
                                <li>
                                    <a
                                        ...
                                        class="flex hover:bg-gray-100 transition duration-150 ease-in px-5 py-3"
                                    >
                                        <img src="https://s.gravatar.com/avatar/5f6728474d8b5356723019d370ed6a0d?s=80" class="rounded-xl w-10 h-10" alt="avatar">
                                        <div class="ml-4">
                                            <div>
                                                <span class="font-semibold">drehimself</span> commented on
                                                <span class="font-semibold">This is my idea</span>:
