<x-app-layout>
    ...
    <div class="ideas-container space-y-6 my-6">
        <div class="idea-container hover:shadow-card transition duration-150 ease-in bg-white rounded-xl flex cursor-pointer">
         ...
         transition duration-150 ease-in  px-4 py-3">Vote
                    </button>
                </div>
            </div>
                        ...
                        <div x-data="{ isOpen: false }" class="flex items-center space-x-2">
                            ...
                            <button @click="isOpen =!isOpen"
                                ...
                                <ul
                                    ...
                                    class="absolut w-44 text-left font-semibold bg-white shadow-card rounded-xl  py-3 ml-3 ">
                    ...
                    <div class="flex items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <button
                                ...
                                <ul class="absolut w-44 text-left font-semibold bg-white shadow-card rounded-xl  py-3 ml-3 ">
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Mark as Spam</a></li>
                                    <li><a href="#" class="hover:bg-gray-100 block transition duration-150 ease-in px-5 py-3">Delete Post</a></li>
                                </ul>
                            </button>
